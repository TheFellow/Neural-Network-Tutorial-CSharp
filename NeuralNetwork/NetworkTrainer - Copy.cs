...
namespace NeuralNetwork
{
    ...
    public class NetworkTrainer
    {
        ...
        private bool _TrainEpochAction()
        {
            ...
            for (int i = 0; i < dataSet.Size && success; i++)
            {
                ...
                if (success)
                    success = AfterTrainDataPoint(ref input, ref output);
            }
    ...
    public class MyNetworkTrainer : NetworkTrainer
    {
        public MyNetworkTrainer(BackPropagationNetwork BPN, DataSet DS)
            : base(BPN, DS)
        {
            // Do nothing
        }

        protected override bool BeforeTrainDataSet()
        {
            Console.WriteLine("BeforeTrainDataSet()");
            return base.BeforeTrainDataSet();
        }

        protected override bool AfterTrainDataSet()
        {
            Console.WriteLine("AfterTrainDataSet()");
            return base.AfterTrainDataSet();
        }

        protected override bool BeforeTrainEpoch()
        {
            Console.WriteLine("BeforeTrainEpoch()");
            return base.BeforeTrainEpoch();
        }

        protected override bool AfterTrainEpoch()
        {
            Console.WriteLine("AfterTrainEpoch()");
            return base.AfterTrainEpoch();
        }

        protected override bool BeforeTrainDataPoint(ref double[] Input, ref double[] Output)
        {
            Console.WriteLine("BeforeTrainDataPoint()");
            return base.BeforeTrainDataPoint(ref Input, ref Output);
        }

        protected override bool AfterTrainDataPoint(ref double[] Input, ref double[] Output)
        {
            Console.WriteLine("AfterTrainDataPoint()");
            return base.AfterTrainDataPoint(ref Input, ref Output);
        }
